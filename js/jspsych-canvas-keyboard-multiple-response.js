...
jsPsych.plugins["canvas-keyboard-multiple-response"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var new_html = '<div id="jspsych-canvas-keyboard-multiple-response-stimulus">' + '<canvas id="jspsych-canvas-stimulus" height="' + trial.canvas_size[0] + '" width="' + trial.canvas_size[1] + '"></canvas>' + '</div>';
    // add prompt
    ...
    var after_response = function (info) {
      ...
      display_element.querySelector('#jspsych-canvas-keyboard-multiple-response-stimulus').className += ' responded';
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function () {
        display_element.querySelector('#jspsych-canvas-keyboard-multiple-response-stimulus').style.visibility = 'hidden';
